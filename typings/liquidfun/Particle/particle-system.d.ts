...
declare type ParticleIndex = number;

declare interface ParticleContact {
...
declare interface ParticleBodyContact {
 ...
 */
declare interface ParticlePair {
 ...
 */
declare interface ParticleTriad {
...
declare class ParticleSystemDef implements ClassHandle<ParticleSystemDef> {
  /**
 ...
 */
declare class FixedSetAllocator {
  // Set buffer.
  private buffer: void;
 ...
 */
declare class TypedFixedSetAllocator<T> extends FixedSetAllocator {
  /**
...
declare class ParticlePairSet extends TypedFixedSetAllocator<ParticlePair> {
  /**
   * Initialize members of this class.
   * @param allocator
   */
...
declare interface LightweightPair<A, B> {
  first: A;
  second: B;
...
declare type FixtureParticle = LightweightPair<Fixture, number>;

declare class FixtureParticleSet extends TypedFixedSetAllocator<
  FixtureParticle
> {
  /**
   * Initialize members of this class.
