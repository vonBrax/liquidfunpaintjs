...
declare class ParticleColor implements ClassHandle<ParticleColor> {
  /**
 ...
 * @param timeStep
 */
declare function CalculateParticleIterations(
  gravity: number,
  radius: number,
  timeStep: number,
): number;
 ...
 */
declare class ParticleHandle extends TypedIntrusiveListNode<ParticleHandle> {
