...
class PointerInputBuffer {
  ...
  constructor(module: EmscriptenModule, tag?: string) {
    this.TAG = tag;
...
export class PointerInfo {
  ...
  private static sPointerInputBuffer: PointerInputBuffer; // = new PointerInputBuffer(PointerInfo.TAG);
  ...
  // Member methods
  constructor(pointerId: number, module: EmscriptenModule) {
    this.mPointerId = pointerId;
    PointerInfo.sPointerInputBuffer = new PointerInputBuffer(
      module,
      PointerInfo.TAG,
    );
  }
