...
export class ParticleRenderer {
  ...
  private mParticleColorByteSize = 4 * 1;
  private mParticlePositionByteSize = 2 * 4;
  private mParticleWeightByteSize = 1 * 4;
  ...
  public draw(): void {
    ...
    try {
      ...
      if (worldParticleCount > 0) {
        ...
        this.mParticlePositionBuffer.setSize(
          this.mParticlePositionByteSize * worldParticleCount,
        );
        ...
        this.mParticleColorBuffer.setSize(
          this.mParticleColorByteSize * worldParticleCount,
        );
        ...
        this.mParticleWeightBuffer.setSize(
          this.mParticleWeightByteSize * worldParticleCount,
        );
      }
      ...
      TextureRenderer.getInstance(this.mModule).drawTexture(
        this.mPaperTexture,
  ...
  public async onSurfaceCreated(): Promise<void> {
    ...
    this.mBlurRenderer = new BlurRenderer(this.mModule);
