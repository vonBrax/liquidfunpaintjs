...
export class TextureRenderer {
  ...
  constructor(module: EmscriptenModule) {
    ...
    const gl = state.get('context') as WebGL2RenderingContext;
   ...
   */
  public static getInstance(module: EmscriptenModule): TextureRenderer {
    if (!this.INSTANCE) {
      this.INSTANCE = new TextureRenderer(module);
    }
